...
public class Tarjeta extends Deco_Medio_Pago
{
    protected Pago pago;
    
    public Tarjeta(Factura factura, Deco_Medio_Pago medio_de_pago, Pago pago)
    {
    ...
    public double getMontoPago()
    {
        ...
        return monto * 1.5 * bonificacion; //por ser tarjeta
